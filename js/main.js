...
const scrollActive = ()=>{
    ...
    sections.forEach(current =>{
        ...
        // while scrolling with the responsive nav-bar open, the right section appears green (ex: if we're on the section 'shop', the shop navbar turns into active-link)
